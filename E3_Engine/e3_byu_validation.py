...
if __name__ == "__main__":
    validation_report = main()data['48K']['magnetic_fields'], temp_data['48K']['experimental'], 'bo-', label='Experimental 48K')
        axes[0, 1].plot(temp_data['48K']['magnetic_fields'], temp_data['48K']['predictions'], 'ro-', label='E3 Predicted 48K')
        axes[0, 1].plot(temp_
